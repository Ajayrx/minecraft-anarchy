...
const HeroBanner = () => {
  return (
    <div className="relative h-64 md:h-96 overflow-hidden mb-8 border-2 border-black">
      {/* Simple gradient background replacing complex layered elements */}
      <div className="absolute inset-0 bg-gradient-to-b from-blue-400 to-sky-600 z-0"></div>
      
      {/* Simplified mountains with fewer elements */}
      ...
      {/* Simplified trees - just keeping one */}
      ...
      {/* Overlay text - simplified and more optimized */}
      <div className="absolute inset-0 flex items-center justify-center z-40">
        <h2 className="text-xl md:text-3xl font-pixel text-white drop-shadow-[1px_1px_0_rgba(0,0,0,0.8)] text-center px-4">
          NO RULES || VOICE CHAT + DISTANT HORIZON
        </h2>
      </div>
    </div>
  );
