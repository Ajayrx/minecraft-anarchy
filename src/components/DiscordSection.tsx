...
const DiscordSection = () => {
  return <section id="discord" className="py-12 md:py-16 bg-[#5865F2]/10 relative">
      {/* Background textures */}
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-lg border-2 border-[#5865F2] shadow-lg space-y-6">
          ...
          <a href="https://discord.gg/wKt4tsbxwj" target="_blank" rel="noopener noreferrer" className="inline-block pixel-button group transform hover:scale-105 transition-all duration-200 py-3 px-6 bg-[#5865F2] hover:bg-[#4a54c6]">
          ...
          <p className="text-sm text-gray-600">
            Already on Discord? Search for our server: <span className="font-mono font-bold">Eternel.eu</span>
          </p>
        </div>
      </div>
    </section>;
